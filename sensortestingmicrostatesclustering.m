...
% Check each variable and check if it is correct or not.
    ...
    %%%
        ...
        microstates_clusters_map_name = 'Microstates-Clusters-Test';
...
if(run_analysis_microstates == 1)
    ...
    %%%
        microstates_file = Read_Directory(location_data_to,microstates_clusters_map_name,microstates_clusters_file_name);
        microstates = Extract_Microstates_Clusters_From_File(microstates_file);
