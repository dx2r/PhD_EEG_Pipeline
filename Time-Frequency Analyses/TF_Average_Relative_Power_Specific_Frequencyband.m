function [power_values] = TF_Average_Relative_Power_Specific_Frequencyband(data, sample_freq, epoch_length, bin_width, freq_range_interest, freq_range_whole)
...
%
% EXAMPLE: 
%   [power_values] = TF_Relative_Power(data, 512, 3, 0.5, [13 17], [0.5 40]);
%
...
for current_epoch = 1:epoch_amount
    ...
    current_powers = TF_Relative_Power_Specific(current_data, sample_freq, bin_width, freq_range_interest, freq_range_whole);    
