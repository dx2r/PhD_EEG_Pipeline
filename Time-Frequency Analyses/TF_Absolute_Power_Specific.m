function [power_values] = TF_Absolute_Power_Specific(data, sample_freq, bin_width, freq_range_interest, freq_range_whole)
...
specific_pow = sum(psd_values(freq_range_interest(1)/bin_width:freq_range_interest(2)/bin_width,:)); %specific absolute power
%Step 3: return absolute power values
