...
% NOTE: This function uses the "TF_Relative_Power" function for the individual epoch calculations
%
% INPUT:
...
%
% EXAMPLE: 
%   [power_values] = TF_Relative_Power(data, 512, 0.5, [0.5 4], [4 8], [8 13], [13 30]);
%
...
for current_epoch = 1:epoch_amount
    ...
    current_powers = TF_Relative_Power(current_data, sample_freq, bin_width, delta_range, theta_range, alpha_range, beta_range);    
