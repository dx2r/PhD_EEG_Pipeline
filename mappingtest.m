...
% Check each variable and check if it is correct or not.
    ...
    %%% 
        ...
        location_data_to = "D:\UGent\Burgie\Jaar 4\Thesis\Datasets\Dataset2\Results (Source)\"; %full path to the directory where the new data needs to be stored. 
        location_data_information = "D:\UGent\Burgie\Jaar 4\Thesis\Datasets\Dataset2\Results (Source)\"; %full path to the directory where the dataset information needs to be stored
        location_data_statistics = "D:\UGent\Burgie\Jaar 4\Thesis\Datasets\Dataset2\Results (Source)\"; %full path to the directory where the statistical .csv file needs to be stored.
    ...
    %%%
        ...
        microstates_clusters_map_name = 'Microstates-Clusters2';
        microstates_clusters_file_name = "microstates";
        microstates_results_map_name = 'Microstates-Results2';
...
%             
        ...
        %microstates = Cluster_Microstates(all_participants_gfp_peaks, 8, "k-means", data_type, {100});
        microstates = Cluster_Microstates(all_participants_gfp_peaks, 10, "modified k-means", data_type, {5,100});
