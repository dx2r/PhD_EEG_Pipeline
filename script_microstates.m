...
% Check each variable and check if it is correct or not.
    ...
    %%% 
        ...
        location_data_to = "D:\UGent\Burgie\Jaar 4\Thesis\Datasets\Dataset2\FinalResults (Sensor)\"; %full path to the directory where the new data needs to be stored. 
        location_data_information = "D:\UGent\Burgie\Jaar 4\Thesis\Datasets\Dataset2\FinalResults (Sensor)\"; %full path to the directory where the dataset information needs to be stored
        location_data_statistics = "D:\UGent\Burgie\Jaar 4\Thesis\Datasets\Dataset2\FinalResults (Sensor)\"; %full path to the directory where the statistical .csv file needs to be stored.
    %%%
    % MAP NAME VARIABLES
    %%%
        ...
        microstates_clusters_map_name = 'Microstates2';
...
if(run_clustering_microstates == 1)
    ...
    %%%
        ...
        microstates = Cluster_Microstates(all_participants_gfp_peaks, 8, "modified k-means", "sensor", {5, 100});
        %save the results in the previously defined map
