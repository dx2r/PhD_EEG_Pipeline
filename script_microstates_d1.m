...
% Check each variable and check if it is correct or not.
    ...
    %%% 
        ...
        location_data_to = "D:\UGent\Burgie\Jaar 4\Thesis\Datasets\Dataset1\Results (Sensor)\"; %full path to the directory where the new data needs to be stored. 
        location_data_information = "D:\UGent\Burgie\Jaar 4\Thesis\Datasets\Dataset1\Results (Sensor)\"; %full path to the directory where the dataset information needs to be stored
        location_data_statistics = "D:\UGent\Burgie\Jaar 4\Thesis\Datasets\Dataset1\Results (Sensor)\"; %full path to the directory where the statistical .csv file needs to be stored.
    %%%
    % MAP NAME VARIABLES
    %%%
        ...
        microstates_clusters_map_name = 'Microstates-Clusters-Poster';
        microstates_clusters_file_name = "microstates";
        microstates_results_map_name = 'Microstates-Results-age';
...
if(run_clustering_microstates == 1)
    ...
    %%%
        ...
        for participant_i = 1:1:dataset_size
            ...
            [current_participant_gfp_peaks] = Extract_GFP_Peaks(current_participant_region_timeseries, sample_frequency, epoch_length);
...
%             
        ...
        microstates = Cluster_Microstates(all_participants_gfp_peaks, 4, "modified k-means", {3, 300});
